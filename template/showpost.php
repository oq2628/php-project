...
<?php foreach($getbyids as $getbyid) : ?>
    <div class="form-group row" style="margin-bottom:0px; height:100%;">
        <textarea class="col-3" style=" padding: 0;
                                        margin: 0 0 0 40px;
    ...
    <div class="form-group row">
        ...
        <div class="col-8">
          <textarea id="textarea1" name="textarea1" cols="40" rows="5" class="form-control" style="display:flex; margin:auto; outline-style:none;" required><?php echo $getbyid[2]?></textarea>
        </div>
    </div>
<?php endforeach; ?>
</form>
